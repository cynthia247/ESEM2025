    ...
    def get_train_examples(self, data_dir):
        ...
        train_data_issue = pd.read_csv(
            os.path.join("satd/multi_train/" + data_dir + "_data/",
                         data_dir + "issue.csv"), header=None, sep=",").values
        train_data_pr = pd.read_csv(
            os.path.join("satd/multi_train/" + data_dir + "_data/",
                         data_dir + "pr.csv"), header=None, sep=",").values
        train_data_commit = pd.read_csv(
            os.path.join("satd/multi_train/" + data_dir + "_data/",
                         data_dir + "commit.csv"), header=None, sep=",").values
        train_data_code_comments = pd.read_csv(
            os.path.join("satd/multi_train/" + data_dir + "_data/",
                         data_dir + "code_comments.csv"), header=None, sep=",").values
...
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer):
    ...
    label_map_1 = {"yes": 1, "no": 0}
    label_map_2 = {"yes": 1, "no": 0}
    label_map_3 = {"yes": 1, "no": 0}
    label_map_4 = {"yes": 1, "no": 0}
