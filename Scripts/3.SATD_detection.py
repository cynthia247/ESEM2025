...
def copy_csv_to_SATD_detector_tool(root_directory):
    print("\n")
    ...
    for dirpath,_,filenames in os.walk(root_directory):
        for file in filenames:
            if file.endswith('.csv'):
                ...
                df.to_csv(f'mt-bert-satd-tool/unclassified_files/{file}',index=False)
...
def SATD_detection(unclassified_file_directory,tool_directory):
    ...
    for dirpath,_,filenames in os.walk(unclassified_file_directory):
        for file in filenames:
            ...
            shutil.copy(f'mt-bert-satd-tool/mt-bert-satd/predict_files/predict_{csv_file}.csv', f'mt-bert-satd-tool/results/predict_{csv_file}.csv')

        


if __name__ == "__main__":
    root_directory="Scripts/results/"
    ...
    # copy_csv_to_SATD_detector_tool(unclassified_file_directory)
