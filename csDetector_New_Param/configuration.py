...
class Configuration:
    def __init__(
        self,
        repositoryUrl: str,
        batchMonths: np.int64,
        outputPath: str,
        sentiStrengthPath: str,
        maxDistance: np.int64,
        pat: str,
        googleKey: str,
        startDate: str,
        endDate: str
        ...
        # build repo path
        self.repositoryPath = os.path.join('/home/uji657/Downloads/Software_Maintenance_Course/Project/csDetector-master_NewParam/tool_automation', split[3], split[4])

        # build results path
        self.resultsPath = os.path.join(f'/home/uji657/Downloads/Software_Maintenance_Course/Project/csDetector-master_NewParam/tool_automation/{self.repositoryName}/release_{self.startDate}')

        # build metrics path
        self.metricsPath = os.path.join(f'/home/uji657/Downloads/Software_Maintenance_Course/Project/csDetector-master_NewParam/tool_automation/{self.repositoryName}/release_{self.startDate}', "metrics")
