...
for i, row in df.iterrows():
    ...
    if release_dates:
        ...
        # Save to CSV
        csv_filename = f'/home/uji657/Downloads/Software_Maintenance_Course/Project/csDetector-master_NewParam/tool_automation/{repo}.csv'
        df.to_csv(csv_filename, index=False)
        # shutil.copy(f'{csv_filename}', f'/home/uji657/Downloads/Software_Maintenance_Course/Project/csDetector-master_NewParam/tool_automation/{repo}.csv')
